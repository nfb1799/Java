...
public class LinkedStack<E> implements Cloneable
{
   ...
   **/ 
   ...
   /**
   * Find the item at a certain index down the stack
   * @param index
   *     how far down the stack to search
   * @precondition
   *     the given index is a nonnegative number
   * @return answer 
   ...
   **/
   ...
   {
      LinkedStack<E> clonedStack = this.clone();
      E answer;
